...
public class TankDrive extends Command {
  ...
  protected void execute() {
    ...
    Robot.driveTrain.setLeftMotor(leftStickY); //multiply by a number like .5 for less sensitive movement
  ...
  @Override
  protected void end() {
    Robot.driveTrain.setLeftMotor(0); //Just incase it doesn't stop regularly
